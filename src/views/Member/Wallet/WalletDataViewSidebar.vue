  ...
  >
    ...
    >
      <div class="p-6">
        ...
        />
        <span class="text-danger text-sm" v-show="errors.has('金额')">{{ errors.first('金额') }}</span>
...
import { addWallet, spendWallet } from "@/http/member.js";
...
export default {
  ...
  computed: {
    ...
    isFormValid() {
      return !this.errors.any() && this.dataMoney;
    },
    scrollbarTag() {
